...
from onceml.configs.k8sConfig import COMPONENT_POD_LABEL_VALUE
...
class BaseDriver(abc.ABC):
    def __init__(self, component: base_component.BaseComponent,
        ...
        self._executor: base_executor.BaseExecutor = self._component._executor
        self._executor.pod_label_value = COMPONENT_POD_LABEL_VALUE.format(project, pipeline_root[0], pipeline_root[1], component.id)
